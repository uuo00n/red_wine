...
这里是黄俊博的JSP程序，当您看到这个JSP页面时，表示您的TOMCAT已经运行成功了！！ <br data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-12"
                                                  data-genuitec-path="/red_wine/WebRoot/index.jsp">
</body>
</html>
