    ...
    <div class="content_box">
        ...
        <div class="news_box">
            ...
            <ul class="news_list">
                ...
                %>
                <a href="${pageContext.request.contextPath }/servlet/HomeServlet?method=information_detail&id=<%=result.getId() %>">
                    <li> >>  <%=result.getTitle() %>
                    </li>
                </a>
                <%
        ...
        <div class="knowledge_box">
            ...
            <ul class="news_list">
                ...
                %>
                <a href="${pageContext.request.contextPath }/servlet/HomeServlet?method=knowledge_detail&id=<%=result.getId() %>">
                    <li> >>  <%=result.getTitle() %>
                    </li>
                </a>
                <%
