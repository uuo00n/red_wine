...
<div class="red_wine_box">
    ...
    <div class="news_list_box">
        ...
        <div class="news_list_box_right">
                ...
                <c:choose>
                    <c:when test="${not empty result.list}">
                        <c:forEach var="result" items="${result.list}">
                            <li>
                                <a href="${pageContext.request.contextPath }/servlet/HomeServlet?method=knowledge_detail&id=${result.id}"
            ...
            <ul class="list_page">
                <li>
                    <a href="${pageContext.request.contextPath }/servlet/HomeServlet?currentPage=${result.PageDate.currentPage-1}&method=knowledge"
                       class="list_a"> <
                        <上一页
                    </a></li>
