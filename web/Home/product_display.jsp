    ...
    <div class="content_boxs">
        ...
        <div class="nav_left">
                ...
                <c:choose>
                    <c:when test="${not empty result.clist}">
                        <c:forEach var="result" items="${result.clist}">
                            <a href="${pageContext.request.contextPath }/servlet/HomeServlet?method=search_commodity&cid=${result.id}">
                                <li class="manage_products_unchecked">${result.title}</li>
                            </a>
                        </c:forEach>
                    </c:when>
                    <c:otherwise>
            ...
            <div class="search_box">
                ...
                <div class="search">
                    <form method="post"
                          action="${pageContext.request.contextPath }/servlet/HomeServlet?method=search_commodity"
                ...
                <c:when test="${not empty result.list}">
                    <c:forEach var="result" items="${result.list}">
                        <div class="goods">
                            ...
                            <a href="${pageContext.request.contextPath }/servlet/HomeServlet?id=${result.id}&method=commodity_detail"><img
                                    src="${pageContext.request.contextPath }/upload/${result.photo}"></a>
                            <p> ${result.title} </p>
            ...
            <div class="page_box" id="${result.url}">
                ...
                <ul>
                    <li class="page_choice"><a
                            href="${pageContext.request.contextPath }/servlet/HomeServlet?currentPage=1&method=${(not empty result.cid) ? result.url : 'commodity'}"
                            class="list_a">首页</a></li>
                    <li class="page_choice"><a
                            href="${pageContext.request.contextPath }/servlet/HomeServlet?currentPage=${result.PageDate.currentPage-1}&method=${(not empty result.cid) ? result.url : 'commodity'}"
                    ...
                    <li class="page_choice"><a
                            href="${pageContext.request.contextPath }/servlet/HomeServlet?currentPage=${result.PageDate.totalPage}&method=${(not empty result.cid) ? result.url : 'commodity'}"
