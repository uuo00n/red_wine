...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-19"
      data-genuitec-path="/red_wine/WebRoot/sys/classify/update.jsp">


<!-- 页面标题 -->
<div id="TitleArea" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-19"
     data-genuitec-path="/red_wine/WebRoot/sys/classify/update.jsp">
    ...
    <div id="TitleArea_Title">
        <div id="TitleArea_Title_Content">
            ...
            <img border="0" width="13" height="13"
                 src="${pageContext.request.contextPath }/sys/style/images/title_arrow.gif"/> 更新分类
    ...
    <form action="${pageContext.request.contextPath }/servlet/ClassificationServlet?method=update" method="post">
        ...
        <div class="ItemBlock_Title">
            <img width="4" height="7" border="0"
                 src="${pageContext.request.contextPath }/sys/style/images/item_point.gif"> 分类信息&nbsp;
        </div>
        <!-- 本段表单字段 -->
