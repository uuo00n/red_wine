...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-41"
	  data-genuitec-path="/red_wine/WebRoot/sys/recruit/update.jsp">

<!-- 页面标题 -->
<div id="TitleArea" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-41"
	 data-genuitec-path="/red_wine/WebRoot/sys/recruit/update.jsp">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
			...
			<img border="0" width="13" height="13"
				 src="${pageContext.request.contextPath }/sys/style/images/title_arrow.gif"/> 更新招贤纳士
...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath }/servlet/RecruitServlet?id=${listClass.id}&method=update"
		  method="post">
		<!-- 本段标题（分段标题） -->
		<div class="ItemBlock_Title">
			<img width="4" height="7" border="0"
				 src="${pageContext.request.contextPath }/sys/style/images/item_point.gif"> 招贤纳士&nbsp;
		</div>
		<!-- 本段表单字段 -->
			...
			<div class="ItemBlock">
				<div class="ItemBlock2">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						...
						<tr>
							<td>职位描述</td>
							<td><textarea name="job_describe" class="TextareaStyle">${listClass.job_describe}</textarea>
								*
							</td>
						</tr>
						<tr>
							<td>招聘要求</td>
							<td><textarea name="requirement" class="TextareaStyle">${listClass.requirement}</textarea> *
							</td>
						</tr>
