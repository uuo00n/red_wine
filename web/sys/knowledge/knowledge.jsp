...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-28"
      data-genuitec-path="/red_wine/WebRoot/sys/knowledge/knowledge.jsp">
<!-- 页面标题 -->
<div id="TitleArea" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-28"
     data-genuitec-path="/red_wine/WebRoot/sys/knowledge/knowledge.jsp">
