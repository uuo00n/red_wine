...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-29"
      data-genuitec-path="/red_wine/WebRoot/sys/knowledge/update.jsp">

<!-- 页面标题 -->
<div id="TitleArea" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-29"
     data-genuitec-path="/red_wine/WebRoot/sys/knowledge/update.jsp">
    ...
    <div id="TitleArea_Title">
        <div id="TitleArea_Title_Content">
            ...
            <img border="0" width="13" height="13"
                 src="${pageContext.request.contextPath }/sys/style/images/title_arrow.gif"/> 更新红酒知识
...
<div id="MainArea">
    <!-- 表单内容 -->
    <form action="${pageContext.request.contextPath }/servlet/KnowledgeServlet?id=${listClass.id}&method=update"
          method="post">
        <!-- 本段标题（分段标题） -->
