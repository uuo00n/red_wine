...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-26"
      data-genuitec-path="/red_wine/WebRoot/sys/information/update.jsp">
<!-- 页面标题 -->
<div id="TitleArea" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-26"
     data-genuitec-path="/red_wine/WebRoot/sys/information/update.jsp">
    <div id="TitleArea_Head"></div>
    <div id="TitleArea_Title">
        <div id="TitleArea_Title_Content">
            <img border="0" width="13" height="13"
                 src="${pageContext.request.contextPath }/sys/style/images/title_arrow.gif"/> 更新公司资讯
        </div>
    </div>
...
<div id="MainArea">
    <!-- 表单内容 -->
    <form action="${pageContext.request.contextPath }/servlet/InformationServlet?id=${listClass.id}&method=update"
          method="post">
        <!-- 本段标题（分段标题） -->
        <div class="ItemBlock_Title">
            <img width="4" height="7" border="0"
                 src="${pageContext.request.contextPath }/sys/style/images/item_point.gif"> 公司资讯&nbsp;
        </div>
        <!-- 本段表单字段 -->
            ...
            <div class="ItemBlock">
                <div class="ItemBlock2">
                    <table cellpadding="0" cellspacing="0" class="mainForm">
                        ...
                        <tr>
                            <td>作者</td>
                            <td><input type="text" name="author" class="InputStyle" value="${listClass.author }"/> *
                            </td>
                        </tr>
                        <tr>
                            <td>发布时间</td>
