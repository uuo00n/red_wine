...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-36"
      data-genuitec-path="/red_wine/WebRoot/sys/public/left.jsp">

<ul id="Menu" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-36"
    data-genuitec-path="/red_wine/WebRoot/sys/public/left.jsp">
    <li class="level1">
        ...
        <ul class="MenuLevel2">
            ...
            <li class="level2 level2Style">
                <a target="right"
                   href="${pageContext.request.contextPath }/servlet/CommodityServlet?method=list">产品管理</a>
            </li>
            <li class="level2 level2Style">
                <a target="right"
                   href="${pageContext.request.contextPath }/servlet/KnowledgeServlet?method=list">红酒知识</a>
            </li>
            <li class="level2 level2Style">
                <a target="right"
                   href="${pageContext.request.contextPath }/servlet/InformationServlet?method=list">公司资讯</a>
            </li>
            <li class="level2 level2Style">
