...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-20"
      data-genuitec-path="/red_wine/WebRoot/sys/goods/add.jsp">

<!-- 页面标题 -->
<div id="TitleArea" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-20"
     data-genuitec-path="/red_wine/WebRoot/sys/goods/add.jsp">
    ...
    <div id="TitleArea_Title">
        <div id="TitleArea_Title_Content">
            ...
            <img border="0" width="13" height="13"
                 src="${pageContext.request.contextPath }/sys/style/images/title_arrow.gif"/> 添加新商品
...
<div id="MainArea">
    <!-- 表单内容 -->
    <form action="${pageContext.request.contextPath }/servlet/UploadServlet?method=add" method="post"
          enctype="multipart/form-data">
        <!-- 本段标题（分段标题） -->
        <div class="ItemBlock_Title">
            <img width="4" height="7" border="0"
                 src="${pageContext.request.contextPath }/sys/style/images/item_point.gif"> 商品信息&nbsp;
        </div>
        <!-- 本段表单字段 -->
