...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-32"
      data-genuitec-path="/red_wine/WebRoot/sys/profile/add.jsp">

<!-- 页面标题 -->
<div id="TitleArea" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-32"
     data-genuitec-path="/red_wine/WebRoot/sys/profile/add.jsp">
    <div id="TitleArea_Head"></div>
    <div id="TitleArea_Title">
        <div id="TitleArea_Title_Content">
            <img border="0" width="13" height="13"
                 src="${pageContext.request.contextPath }/sys/style/images/title_arrow.gif"/>添加公司简介
        </div>
    </div>
